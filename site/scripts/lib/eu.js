...
export const PROCEDURAL_STATUS = [
  ...
  'IMMUNITY UPHELD', 'CHARGED', 'INDICTED', 'ON TRIAL', 'CONVICTED', 'ACQUITTED', 'CASE DISMISSED',
  'INVESTIGATION CLOSED', 'WITNESS', 'NOT ACCUSED', 'COOPERATING WITNESS',
...
export const ESTABLISHED_STATES = ['CONVICTED', 'MALADMINISTRATION FINDING'];
...
export const CASE_STATUS_LABELS = [
  ...
  'IMMUNITY PROCEEDINGS', 'PUBLIC STATUS UNCLEAR',
];

export const MONEY_CLASSIFICATIONS = [
  'SEIZED CASH', 'ALLEGED PAYMENT', 'ALLEGED BRIBE', 'PUBLIC EXPENDITURE', 'CONTRACT VALUE',
  'DECLARED BENEFIT', 'EXPENSE', 'EU FUNDING', 'AMOUNT CLAIMED', 'AMOUNT RECOVERED',
